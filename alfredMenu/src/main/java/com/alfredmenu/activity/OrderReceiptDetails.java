...
public class OrderReceiptDetails extends BaseActivity {
	...
	private void refreshOrderTotal(){
		((TextView)findViewById(R.id.tv_sub_total)).setText(
				context.getResources().getString(R.string.subtotal)+" : "+ App.instance.getCurrencySymbol() + BH.formatMoney(currentOrder.getSubTotal()));
		...
		((TextView)findViewById(R.id.tv_grand_total)).setText(App.instance.getCurrencySymbol() + BH.formatMoney(currentOrder.getTotal()));
	}
	...
	class OrderDetailListAdapter extends BaseAdapter {
		...
		public View getView(int arg0, View arg1, ViewGroup arg2) {
			...
			holder.price.setText(App.instance.getCurrencySymbol() + BH.formatMoney(orderDetail.getItemPrice()));
			holder.tv_qty.setText(orderDetail.getItemNum() + "");
			holder.tv_qty.setTag(orderDetail);
			holder.subtotal.setText(App.instance.getCurrencySymbol() + BH.formatMoney(orderDetail.getRealPrice()));
			return arg1;
		}
