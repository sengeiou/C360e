...
import com.alfredmenu.view.ViewfinderView;
import com.alfredmenu.zxing.CameraManager;
import com.alfredmenu.zxing.ConnectPOSHandler;
import com.alfredmenu.zxing.InactivityTimer;
...
public class ConnectPOS extends BaseActivity implements Callback,
	...
	private void initTextTypeFace(View QRConnectView, View IPConnectView) {
		...
		textTypeFace.setTrajanProRegular((TextView)IPConnectView.findViewById(R.id.tv_setup_ip));
