...
public class OrderAdapter extends BaseExpandableListAdapter {
	...
	public OrderAdapter(Context context, List<ItemCategoryAndDetails> tables,
			Handler handler,SetItemCountWindow setItemCountWindow, ModifierCountView.OnCountChange onCountChange) {
	...
	public OrderAdapter(Context context,
						Handler handler, ModifierCountView.OnCountChange onCountChange) {
...
//		}
		...
		count_view.setOnCountChange((CountView.OnCountChange) onCountChange);
		return view;
	}
