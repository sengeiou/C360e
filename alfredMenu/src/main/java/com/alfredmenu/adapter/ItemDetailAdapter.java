...
public class ItemDetailAdapter extends RvCateAdapter<ItemDetail> {
    ...
    private CountView.OnNotesChange onNotesChange;
    private SetItemCountWindow setItemCountWindow;
    private WaiterModifierCPWindow modifierCPWindow;
    ...
    public ItemDetailAdapter(Context context, List<ItemDetail> list,SetItemCountWindow setItemCountWindow,WaiterModifierCPWindow modifierCPWindow, RvListener listener,CountView.OnCountChange onCountChange, CountView.OnNotesChange onNotesChange) {
        ...
        this.modifierCPWindow = modifierCPWindow;
...
//                case 3:
                    ...
                    iv_notes = (ImageView) itemView.findViewById(R.id.iv_notes);
...
//                case 3:
                    ...
                    tv_price.setText(App.instance.getCurrencySymbol() + BH.formatMoney(itemDetail.getPrice()));
