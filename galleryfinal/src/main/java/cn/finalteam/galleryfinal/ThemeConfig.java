...
public class ThemeConfig implements Serializable{
    ...
    public static class Builder {
        ...
        private int iconBack = cn.finalteam.galleryfinal.R.drawable.ic_gf_back;
        private int iconCamera = cn.finalteam.galleryfinal.R.drawable.ic_gf_camera;
        private int iconCrop = cn.finalteam.galleryfinal.R.drawable.ic_gf_crop;
        private int iconRotate = cn.finalteam.galleryfinal.R.drawable.ic_gf_rotate;
        private int iconClear = cn.finalteam.galleryfinal.R.drawable.ic_gf_clear;
        private int iconFolderArrow = cn.finalteam.galleryfinal.R.drawable.ic_gf_triangle_arrow;
        private int iconDelete = cn.finalteam.galleryfinal.R.drawable.ic_delete_photo;
        private int iconCheck = cn.finalteam.galleryfinal.R.drawable.ic_folder_check;
        private int iconFab = cn.finalteam.galleryfinal.R.drawable.ic_folder_check;
        private int iconPreview = cn.finalteam.galleryfinal.R.drawable.ic_gf_preview;
