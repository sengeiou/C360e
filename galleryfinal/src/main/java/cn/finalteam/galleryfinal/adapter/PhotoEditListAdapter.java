...
public class PhotoEditListAdapter extends ViewHolderAdapter<PhotoEditListAdapter.ViewHolder, PhotoInfo> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int position) {
        View view = inflate(cn.finalteam.galleryfinal.R.layout.gf_adapter_edit_list, parent);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.mIvPhoto.setImageResource(cn.finalteam.galleryfinal.R.drawable.ic_gf_default_photo);
