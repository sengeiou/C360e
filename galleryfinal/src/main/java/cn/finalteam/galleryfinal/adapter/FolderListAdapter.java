...
public class FolderListAdapter extends ViewHolderAdapter<FolderListAdapter.FolderViewHolder, PhotoFolderInfo> {
    ...
    public FolderViewHolder onCreateViewHolder(ViewGroup parent, int position) {
        View view = inflate(cn.finalteam.galleryfinal.R.layout.gf_adapter_folder_list_item, parent);
    ...
    public void onBindViewHolder(FolderViewHolder holder, int position) {
        ...
        holder.mIvCover.setImageResource(cn.finalteam.galleryfinal.R.drawable.ic_gf_default_photo);
        ...
        holder.mTvPhotoCount.setText(mActivity.getString(cn.finalteam.galleryfinal.R.string.folder_photo_size, size));
    ...
    static class FolderViewHolder extends ViewHolderAdapter.ViewHolder {
        ...
        public FolderViewHolder(View view) {
            super(view);
            this.mView = view;
            mIvCover = (GFImageView) view.findViewById(cn.finalteam.galleryfinal.R.id.iv_cover);
            mTvFolderName = (TextView) view.findViewById(cn.finalteam.galleryfinal.R.id.tv_folder_name);
            mTvPhotoCount = (TextView) view.findViewById(cn.finalteam.galleryfinal.R.id.tv_photo_count);
            mIvFolderCheck = (ImageView) view.findViewById(cn.finalteam.galleryfinal.R.id.iv_folder_check);
        }
    }
}
