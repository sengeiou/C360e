...
public class PhotoSelectActivity extends PhotoBaseActivity implements View.OnClickListener, AdapterView.OnItemClickListener{
        ...
        public void handleMessage(Message msg) {
            ...
            if ( msg.what == HANLDER_TAKE_PHOTO_EVENT ) {
                ...
                if (mAllPhotoFolderList.get(0).getPhotoList() == null ||
                    ...
                    mTvEmptyView.setText(cn.finalteam.galleryfinal.R.string.no_photo);
                }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if ( GalleryFinal.getFunctionConfig() == null || GalleryFinal.getGalleryTheme() == null) {
            ...
            setContentView(cn.finalteam.galleryfinal.R.layout.gf_activity_photo_select);
    ...
    private void setTheme() {
        ...
        if (GalleryFinal.getGalleryTheme().getIconBack() == cn.finalteam.galleryfinal.R.drawable.ic_gf_back) {
        ...
        if (GalleryFinal.getGalleryTheme().getIconFolderArrow() == cn.finalteam.galleryfinal.R.drawable.ic_gf_triangle_arrow) {
        ...
        if (GalleryFinal.getGalleryTheme().getIconClear() == cn.finalteam.galleryfinal.R.drawable.ic_gf_clear) {
        ...
        if (GalleryFinal.getGalleryTheme().getIconPreview() == cn.finalteam.galleryfinal.R.drawable.ic_gf_preview) {
        ...
        if (GalleryFinal.getGalleryTheme().getIconCamera() == cn.finalteam.galleryfinal.R.drawable.ic_gf_camera) {
    ...
    private void findViews() {
        mGvPhotoList = (GridView) findViewById(cn.finalteam.galleryfinal.R.id.gv_photo_list);
        mLvFolderList = (ListView) findViewById(cn.finalteam.galleryfinal.R.id.lv_folder_list);
        mTvSubTitle = (TextView) findViewById(cn.finalteam.galleryfinal.R.id.tv_sub_title);
        mLlFolderPanel = (LinearLayout) findViewById(cn.finalteam.galleryfinal.R.id.ll_folder_panel);
        mIvTakePhoto = (ImageView) findViewById(cn.finalteam.galleryfinal.R.id.iv_take_photo);
        mTvChooseCount = (TextView) findViewById(cn.finalteam.galleryfinal.R.id.tv_choose_count);
        mIvBack = (ImageView) findViewById(cn.finalteam.galleryfinal.R.id.iv_back);
        mFabOk = (FloatingActionButton) findViewById(cn.finalteam.galleryfinal.R.id.fab_ok);
        mTvEmptyView = (TextView) findViewById(cn.finalteam.galleryfinal.R.id.tv_empty_view);
        mLlTitle = (LinearLayout) findViewById(cn.finalteam.galleryfinal.R.id.ll_title);
        mIvClear = (ImageView) findViewById(cn.finalteam.galleryfinal.R.id.iv_clear);
        ...
        mIvFolderArrow = (ImageView) findViewById(cn.finalteam.galleryfinal.R.id.iv_folder_arrow);
        mIvPreView = (ImageView) findViewById(cn.finalteam.galleryfinal.R.id.iv_preview);
    }
    ...
    public void onClick(View v) {
        int id = v.getId();
        if ( id == cn.finalteam.galleryfinal.R.id.ll_title || id == cn.finalteam.galleryfinal.R.id.iv_folder_arrow) {
            if ( mLlFolderPanel.getVisibility() == View.VISIBLE ) {
                mLlFolderPanel.setVisibility(View.GONE);
                mLlFolderPanel.setAnimation(AnimationUtils.loadAnimation(this, cn.finalteam.galleryfinal.R.anim.gf_flip_horizontal_out));
            } else {
                mLlFolderPanel.setAnimation(AnimationUtils.loadAnimation(this, cn.finalteam.galleryfinal.R.anim.gf_flip_horizontal_in));
                mLlFolderPanel.setVisibility(View.VISIBLE);
            }
        } else if ( id == cn.finalteam.galleryfinal.R.id.iv_take_photo ) {
            //判断是否达到多选最大数量
            if (GalleryFinal.getFunctionConfig().isMutiSelect() && mSelectPhotoList.size() == GalleryFinal.getFunctionConfig().getMaxSize()) {
                toast(getString(cn.finalteam.galleryfinal.R.string.select_max_tips));
                return;
            }

            if (!DeviceUtils.existSDCard()) {
                toast(getString(cn.finalteam.galleryfinal.R.string.empty_sdcard));
                return;
            }

            takePhotoAction();
        } else if ( id == cn.finalteam.galleryfinal.R.id.iv_back ) {
            if ( mLlFolderPanel.getVisibility() == View.VISIBLE ) {
                mLlTitle.performClick();
            } else {
                finish();
            }
        } else if ( id == cn.finalteam.galleryfinal.R.id.fab_ok ) {
        ...
        } else if ( id == cn.finalteam.galleryfinal.R.id.iv_clear ) {
            mSelectPhotoList.clear();
            mPhotoListAdapter.notifyDataSetChanged();
            refreshSelectCount();
        } else if ( id == cn.finalteam.galleryfinal.R.id.iv_preview ) {
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        if ( parentId == cn.finalteam.galleryfinal.R.id.lv_folder_list ) {
    ...
    public void refreshSelectCount() {
        mTvChooseCount.setText(getString(cn.finalteam.galleryfinal.R.string.selected, mSelectPhotoList.size(), GalleryFinal.getFunctionConfig().getMaxSize()));
    ...
    public void onPermissionsDenied(List<String> list) {
        mTvEmptyView.setText(cn.finalteam.galleryfinal.R.string.permissions_denied_tips);
        mIvTakePhoto.setVisibility(View.GONE);
    }
    ...
    private void requestGalleryPermission() {
        if (EasyPermissions.hasPermissions(this, Manifest.permission.READ_EXTERNAL_STORAGE)) {
            ...
            EasyPermissions.requestPermissions(this, getString(cn.finalteam.galleryfinal.R.string.permissions_tips_gallery),
                    GalleryFinal.PERMISSIONS_CODE_GALLERY, Manifest.permission.READ_EXTERNAL_STORAGE);
        }
    }

    private void getPhotos() {
        mTvEmptyView.setText(cn.finalteam.galleryfinal.R.string.waiting);
