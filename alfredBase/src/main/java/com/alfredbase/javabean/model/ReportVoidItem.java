...
public class ReportVoidItem implements Serializable{
	/**
	 * 
	 */
	private static final long serialVersionUID = -8033385903114558489L;
	...
	public String toString() {
		return "ReportVoidItem [itemName=" + itemName + ", itemQty=" + itemQty
