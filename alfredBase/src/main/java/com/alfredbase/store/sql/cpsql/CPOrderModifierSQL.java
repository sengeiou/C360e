...
public class CPOrderModifierSQL {
...
//			updateOrderDetailForWaiter(orderModifier);
	...
	public static void updateOrderModifier(SQLiteDatabase db, OrderModifier orderModifier) {
		if (orderModifier == null) {
			return;
		}
		try {
	...
	public static ArrayList<OrderModifier> getAllOrderModifier(Order order) {
		...
		String sql = "select * from " + TableNames.CPOrderModifier
	...
	public static int getOrderModifierCountByOrderDetailAndNormal(OrderDetail orderDetail){
		int result = 0;
		String sql = "select count(0) from " + TableNames.CPOrderModifier
				+ " o,"
				+ TableNames.Modifier
				+ " m"
				+ " where o.orderDetailId = ? and o.status = "
	...
	public static Map<String, String> getAllOrderModifierByOrderDetailType(int modifierId, long businessDate, int orderDetailStatus) {
		...
		String sql = "select sum(modifierPrice), sum(modifierNum) from " + TableNames.CPOrderModifier
...
//			cursor = db.query(TableNames.CPOrderModifier,
...
//					"", "", "");
	...
	public static void updateOrderModifierNum(OrderDetail orderDetail, int num){
		String sql = "update " + TableNames.CPOrderModifier + " set modifierNum = ? where orderDetailId = ?";
		try {
	...
	public static void deleteOrderModifier(OrderModifier orderModifier) {
		String sql = "delete from " + TableNames.CPOrderModifier
				+ " where id = ?";
		try {
