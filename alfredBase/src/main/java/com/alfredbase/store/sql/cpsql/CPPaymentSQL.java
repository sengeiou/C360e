...
public class CPPaymentSQL {
	...
	public static Payment getPayment(Integer paymentID) {
		...
		String sql = "select * from " + TableNames.CPPayment + " where id = ?";
		Cursor cursor = null;
		try {
	...
	public static Payment getPaymentByOrderId(Integer orderId) {
		Payment payment = null;
		String sql = "select * from " + TableNames.CPPayment
	...
	public static void updatePaymentAmount( String paymentAmount, int orderId){
		...
		String sql = "update " + TableNames.CPPayment + " set paymentAmount = ? where orderId = ? " ;
		try {
	...
	public static void updateSplitOrderPaymentAmount( String paymentAmount, int orderSplitId){
		...
		String sql = "update " + TableNames.CPPayment + " set paymentAmount = ? where orderSplitId = ? " ;
		try {
...
//				+ ParamConst.ORDER_STATUS_BOH + ")";
	...
	public static void deletePayment(Payment payment) {
		String sql = "delete from " + TableNames.CPPayment + " where id = ?";
		try {
