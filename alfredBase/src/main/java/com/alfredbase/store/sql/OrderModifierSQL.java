...
public class OrderModifierSQL {
    ...
    public static void addOrderModifier(final OrderModifier orderModifier) {
        addOrderModifier(orderModifier, false);
    }

    public static void addOrderModifier(final OrderModifier orderModifier, Boolean isModifier) {
...
//			updateOrderDetailForWaiter(orderModifier);
    ...
    public static void updateModifierByOrderDetail(OrderDetail orderDetail) {
        List<OrderModifier> orderModifiers = OrderModifierSQL.getOrderModifiersByOrderDetailId(orderDetail.getId());
    ...
    public static void updateOrderDetail(OrderModifier orderModifier) {
