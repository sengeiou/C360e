...
public class CPPaymentSettlementSQL {
	...
	public static PaymentSettlement getPaymentSettlement(
		...
		String sql = "select * from " + TableNames.CPPaymentSettlement
				+ " where id = ?";
		Cursor cursor = null;
		try {
	...
	public static String getPaymentSettlementsSumBypaymentId(Integer paymentID) {
		...
		String sql = "select sum(paidAmount) from "
				+ TableNames.CPPaymentSettlement + " where paymentId = ? and isActive = " + ParamConst.PAYMENT_SETT_IS_ACTIVE;
		Cursor cursor = null;
		SQLiteDatabase db = SQLExe.getDB();
		try {
			cursor = db.rawQuery(sql,
	...
	public static ArrayList<PaymentSettlement> getAllPaymentSettlement() {
		...
		String sql = "select * from " + TableNames.CPPaymentSettlement + " where isActive = " + ParamConst.PAYMENT_SETT_IS_ACTIVE;
		Cursor cursor = null;
		SQLiteDatabase db = SQLExe.getDB();
		try {
	...
	public static void regainPaymentSettlementByPayment(Payment payment) {
		String sql = "delete from " + TableNames.CPPaymentSettlement
				+ " where paymentId = ? and isActive = " + ParamConst.PAYMENT_SETT_IS_ACTIVE;
		String sql1 = "update " + TableNames.CPPaymentSettlement
	...
	public static void updatePaymentAmount( String paymentAmount, String cashChange,  int paymentId){
		...
		String sql = "update " + TableNames.CPPaymentSettlement + " set paidAmount = ?, totalAmount = ?, cashChange = ? where paymentId = ? " ;
		try {
