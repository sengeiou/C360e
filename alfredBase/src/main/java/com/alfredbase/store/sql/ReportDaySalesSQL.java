...
public class ReportDaySalesSQL {
	public static void addReportDaySales(ReportDaySales reportDaySales) {
		...
		try {
			String sql = "replace into "
					...
					+ " updateTime, deliveroo, deliverooQty, ubereats, ubereatsQty, foodpanda, foodpandaQty, voucher, voucherQty, totalHour, reportNoStr,promotionTotal)"
					+ " values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,"
					+ "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
	...
	public static void addReportDaySalesFromCloud(ReportDaySales reportDaySales) {
		...
		try {
			...
			String sql = "replace into "
					...
					+ " takeawayQty, createTime, updateTime, deliveroo, deliverooQty, ubereats, ubereatsQty, foodpanda, foodpandaQty, voucher, voucherQty,totalHour, reportNoStr,promotionTotal)"
					+ " values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,"
					+ "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
			SQLExe.getDB().execSQL(
					sql,
	...
	public static ReportDaySales getReportDaySalesForZReport(long business) {
		...
		String sql = "select restaurantId, restaurantName, revenueId, revenueName, businessDate, sum(itemSales), sum(itemSalesQty), sum(discountPer), sum(discountPerQty), "
				...
				+ " sum(foodpanda), sum(foodpandaQty), sum(voucher), sum(voucherQty), sum(totalHour), reportNoStr,sum(promotionTotal) from "
				+ TableNames.ReportDaySales
				+ " where businessDate = ? ";
		Cursor cursor = null;
		try {
