	...
	public static ArrayList<ReportPluDayComboModifier> getReportPluDayComboModifiersForZReport(long date) {
		...
		try {
			...
			for (cursor.moveToFirst(); !cursor.isAfterLast(); cursor
				...
				reportPluDayComboModifier.setModifierPrice(cursor.getString(9));
				reportPluDayComboModifier.setModifierCount(cursor.getInt(10));
				reportPluDayComboModifier.setBillVoidPrice(cursor.getString(11));
				reportPluDayComboModifier.setBillVoidCount(cursor.getInt(12));
				reportPluDayComboModifier.setVoidModifierPrice(cursor.getString(13));
				reportPluDayComboModifier.setVoidModifierCount(cursor.getInt(14));
				reportPluDayComboModifier.setBohModifierPrice(cursor.getString(15));
				reportPluDayComboModifier.setBohModifierCount(cursor.getInt(16));
				reportPluDayComboModifier.setFocModifierPrice(cursor.getString(17));
				reportPluDayComboModifier.setFocModifierCount(cursor.getInt(18));
				reportPluDayComboModifier.setBillFocPrice(cursor.getString(19));
				...
				reportPluDayComboModifier.setModifierItemPrice(cursor.getString(24));
				reportPluDayComboModifier.setRealPrice(cursor.getString(25));
