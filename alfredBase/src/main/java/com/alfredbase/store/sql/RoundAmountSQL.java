...
public class RoundAmountSQL {
	...
	public static double getSumRoundWhenSplitByOrder(Order order){
		...
		String sql = "select sum(roundBalancePrice) from " + TableNames.RoundAmount +" where orderId = ? and orderSplitId <> 0";
		Cursor cursor = null;
		try {
			cursor = SQLExe.getDB().rawQuery(sql,
	...
	public static void deleteRoundAmount(RoundAmount roundAmount) {
		String sql = "delete from " + TableNames.RoundAmount + " where id = ?";
		try {
	...
	public static void deleteRoundAmount(OrderSplit orderSplit) {
		String sql = "delete from " + TableNames.RoundAmount + " where orderSplitId = ?";
		try {
	...
	public static void deleteRoundAmount(Order order) {
		String sql = "delete from " + TableNames.RoundAmount + " where orderId = ?";
		try {
