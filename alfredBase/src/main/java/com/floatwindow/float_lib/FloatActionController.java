package com.floatwindow.float_lib;

import android.content.Context;
import android.content.Intent;

import com.floatwindow.float_lib.service.FloatMonkService;
...
public class FloatActionController {
    ...
    private OnTrainListener onMTrainListener;
    ...
    public void registerOnTrainListener(OnTrainListener onTrainListener) {
        onMTrainListener = onTrainListener;
    }
    ...
    public  void onClick()
    {
        if (onMTrainListener == null) return;
        onMTrainListener.onTrainClick();
    }
}
