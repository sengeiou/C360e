...
public class KOTPrint extends PrintJob {
    ...
    public void AddHeader(KotSummary kotsummary, String trainString) {
        StringBuilder sbr = new StringBuilder();
        if (kotsummary.getIsTakeAway() == ParamConst.TAKE_AWAY) {
        ...
        } else if (kotsummary.getIsTakeAway() == ParamConst.APP_DELIVERY) {
            sbr.append(PrintService.instance.getResources().getString(R.string.order_no))
                    .append("\t")
                    .append(kotsummary.getNumTag() + kotsummary.getOrderNoString() + trainString)
                    .append(reNext)
                    .append(PrintService.instance.getResources().getString(R.string.delivery)).append(reNext);
        } else if (kotsummary.getIsTakeAway() == ParamConst.DINE_IN) {
            sbr.append(PrintService.instance.getResources().getString(R.string.order_no))
                    .append("\t")
                    .append(kotsummary.getNumTag() + kotsummary.getOrderNoString() + trainString)
                    .append(reNext)
                    .append(PrintService.instance.getResources().getString(R.string.dine_in)).append(reNext);
        } else if (kotsummary.getIsTakeAway() == ParamConst.EMPLOYEE) {
            sbr.append(PrintService.instance.getResources().getString(R.string.order_no))
                    .append("\t")
                    .append(kotsummary.getNumTag() + kotsummary.getOrderNoString() + trainString)
                    .append(reNext)
                    .append(PrintService.instance.getResources().getString(R.string.employee)).append(reNext);
        } else {
            sbr.append(PrintService.instance.getResources().getString(R.string.order_no))
                    .append("\t")
                    .append(kotsummary.getNumTag() + kotsummary.getOrderNoString() + trainString)
