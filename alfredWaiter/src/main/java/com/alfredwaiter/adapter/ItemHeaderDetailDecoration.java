...
public class ItemHeaderDetailDecoration extends RecyclerView.ItemDecoration {
  ...
  //  private CheckListener mCheckListener;
    ...
    public static void setCheckListener(CheckListener checkListener) {
        mCheckListener = checkListener;
    }

    public ItemHeaderDetailDecoration(Context context, List<ItemDetail> datas) {
        this.mDatas = datas;
    ...
    public ItemHeaderDetailDecoration setData(List<ItemDetail> mDatas) {
        this.mDatas = mDatas;
        return this;
    }

    public static void setCurrentTag(String currentTag) {
        ItemHeaderDetailDecoration.currentTag = currentTag;
    }
    ...
    public void onDrawOver(Canvas canvas, final RecyclerView parent, RecyclerView.State state) {
        ...
        if (!TextUtils.equals(tag, currentTag)) {
            Log.d("currentTag--->", tag + "VS" + currentTag);
            currentTag = tag;
