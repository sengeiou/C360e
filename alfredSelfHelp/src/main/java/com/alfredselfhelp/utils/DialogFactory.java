...
//		window.setContentView(R.layout.dialog_item_kpm_qr_btns);
...
//
//
//		TextView back = (TextView) window.findViewById(R.id.tv_backs);
//	//	back.setText(left);
...
//
//
//	public static void QCDialog(final BaseActivity activity,
//			final String title, final String content, final String leftText, final Boolean isqc,
...
//						R.layout.dialog_orderself_detail, null);
...
////				view.findViewById(R.id.img_onclick).setOnClickListener(
////						new OnClickListener() {
////
////							@Override
