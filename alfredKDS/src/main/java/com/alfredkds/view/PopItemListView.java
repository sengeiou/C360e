 ...
 * 
 */
public class PopItemListView extends ListView {
	/**
	...
	public PopItemListView(Context context) {
		this(context, null);
	}

	public PopItemListView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public PopItemListView(Context context, AttributeSet attrs, int defStyle) {
	 ...
	 */
	public PopItemAdapter popItemAdapter;
	public Kot kot;
	public KitchenOrder mContext;
	private boolean isChange = false;
	@Override
	public boolean onTouchEvent(MotionEvent ev) {
		popItemAdapter = (PopItemAdapter) this.getAdapter();
		kot = popItemAdapter.getKot();
