...
package com.alfredposclient.zxing.decode;
...
import com.alfredposclient.zxing.view.ViewfinderResultPointCallback;
...
public final class CaptureActivityHandler extends Handler {
  ...
  private final StoredCardActivity activity;
  ...
  public CaptureActivityHandler(StoredCardActivity activity,
  ...
  public void handleMessage(Message message) {
    switch (message.what) {
      ...
      case R.id.return_scan_result: {
        ...
        if (intent != null && intent.hasExtra("codedContent")) {
          String codedContent = intent.getStringExtra("codedContent");
