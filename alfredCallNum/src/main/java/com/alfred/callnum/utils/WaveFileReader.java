...
public class WaveFileReader {
    ...
    private void initReader(String filename){
        ...
        try {
            ...
            this.mydata = new int[this.len];

            for(int i=0; i<this.len; ++i){
                if(this.bitspersample == 16) {
                    this.mydata[i]=this.readInt();
                }
...
//---------------------
//
//    本文来自 RobinTang 的CSDN 博客 ，全文地址请点击：https://blog.csdn.net/trbbadboy/article/details/7899651?utm_source=copy
}
